...
Slides are [here](./assets/slides/10-decision-trees-and-random-forests.pdf)
...
> Instructor Note: Have students open and work through the exercises in the [starter code notebook](./code/starter-code/starter-code-10.ipynb).
...
> Use the iPython notebooks for [starter](./code/starter-code/starter-code-10.ipynb) and [solution](./code/solution-code/solution-code-10.ipynb) code in this section
